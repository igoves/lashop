<?php if($paginator->hasPages()): ?>
    <ul class="pagination" role="navigation">
        ...
        <?php else: ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($paginator->previousPageUrl(), false); ?>" rel="prev" aria-label="<?php echo e(app('translator')->getFromJson('pagination.previous')); ?>">&lsaquo;</a>
            </li>
        <?php endif; ?>
        ...
        <?php if($paginator->hasMorePages()): ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($paginator->nextPageUrl(), false); ?>" rel="next" aria-label="<?php echo e(app('translator')->getFromJson('pagination.next')); ?>">&rsaquo;</a>
            </li>
        <?php else: ?>
